...
class SliderViewController: UITableViewController {
    ...
    func configureDefaultSlider() {
        ...
        defaultSlider.addTarget(self, action: #selector(sliderValueDidChange(_:)), for: .valueChanged)
    }
    ...
    func configureTintedSlider() {
        ...
        tintedSlider.addTarget(self, action: #selector(sliderValueDidChange(_:)), for: .valueChanged)
    }
    ...
    func configureCustomSlider() {
        ...
        customSlider.addTarget(self, action: #selector(sliderValueDidChange(_:)), for: .valueChanged)
    }
    ...
    func configureMinMaxImageSlider() {
        ...
        minMaxImageSlider.minimumValue = 0
        minMaxImageSlider.maximumValue = 100
        minMaxImageSlider.isContinuous = false
        minMaxImageSlider.value = 44
        minMaxImageSlider.addTarget(self, action: #selector(sliderValueDidChange(_:)), for: .valueChanged)
    }
